...
import '../../../auth/presentation/screens/tabs.dart'; // Import TabsScreen and selectedTabProvider
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(
                height:
                    100), // Alttaki buton ve sayfa indikatörleri için boşluk
          ],
        ),
      ),
    );
